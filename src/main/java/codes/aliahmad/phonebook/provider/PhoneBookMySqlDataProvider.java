...
public class PhoneBookMySqlDataProvider extends AbstractBackEndDataProvider<PhoneBook, CrudFilter>
{
  private final static DataService dataService = MySqlDataService.getInstance();
